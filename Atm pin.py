...
if len(ICICI_user_pin) == 4:
    if ICICI_user_pin == ICICI_deepak_ac_details["ATM PIN"]:
        ...
        if user_choice == 1:
            ...
            if money_w <= ICICI_deepak_ac_details["balance"]:
                ICICI_deepak_ac_details["balance"] -= money_w
                print("Transaction successful")
                print("Remaining balance:", ICICI_deepak_ac_details["balance"])
            else:
        ...
        # ✅ Deposit
            ...
            if deposit_m % 100 == 0 and deposit_m >= 500:
                ICICI_deepak_ac_details["balance"] += deposit_m
                print(f"You have deposited {deposit_m}")
                print("Total balance:", ICICI_deepak_ac_details["balance"])
            else:
        ...
        # ✅ Change PIN (from your image logic)
            ...
            while attempts_remaining > 0:
                ...
                if len(old_pin) == 4:
                    if old_pin == ICICI_deepak_ac_details["ATM PIN"]:
                        new_pin = input("Enter a new 4 digit ATM PIN: ")

                        if len(new_pin) == 4:
                            ICICI_deepak_ac_details["ATM PIN"] = new_pin
